...
export const ReviewsSection = () => {
  ...
  return (
    ...
    >
      <div className="mb-[70px] ml-[154px]">
        <span className="mb-[-6px] inline-flex items-center gap-[6px] text-[10px] font-black uppercase leading-none tracking-[-0.055em] text-[#14352d]">
        ...
        <h2
          ref={headingRef}
          className="font-display text-[clamp(118px,16.2vw,276px)] font-medium leading-[0.77] tracking-[-0.105em] text-[#14352d]"
        >
          Reviews
        </h2>
      </div>
