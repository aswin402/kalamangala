  ...
  return (
    <>
      ...
      <section className="km-reveal mx-auto mt-[84px] w-full px-5 text-center md:mt-[112px] md:px-6">
        ...
        <p className="mx-auto mt-[26px] max-w-[1500px] text-[18px] font-bold leading-[1.35] tracking-[-0.035em] text-foreground md:mt-[42px] md:text-[24px]">
        ...
        <p className="mx-auto mt-[22px] max-w-[1500px] text-[18px] font-bold leading-[1.35] tracking-[-0.035em] text-foreground md:mt-[30px] md:text-[24px]">
      ...
      <section className="km-reveal mx-auto mt-[78px] w-full max-w-[1540px] px-5 md:mt-[108px] md:px-[90px]">
        ...
        <p className="mt-[22px] max-w-[1420px] text-[18px] font-bold leading-[1.35] tracking-[-0.035em] text-foreground md:mt-[34px] md:text-[24px]">
        ...
        <h4 className="mt-[30px] text-[32px] font-bold leading-[0.95] tracking-[-0.06em] text-foreground md:mt-[36px] md:text-[48px]">
