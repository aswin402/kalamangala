  ...
  return (
    <>
      ...
      <section className="am-reveal mx-auto mt-[84px] w-full px-5 text-center md:mt-[112px] md:px-6">
        <h2 className="text-[34px] font-bold leading-[0.95] tracking-[-0.06em] text-[#12362d] md:text-[46px]">
          Crafted by Visionaries, Built for You
        </h2>

        <p className="mx-auto mt-[26px] max-w-[1500px] text-[18px] font-bold leading-[1.35] tracking-[-0.035em] text-[#12362d] md:mt-[42px] md:text-[24px]">
        ...
        <p className="mx-auto mt-[22px] max-w-[1500px] text-[18px] font-bold leading-[1.35] tracking-[-0.035em] text-[#12362d] md:mt-[30px] md:text-[24px]">
      ...
      <section className="am-reveal mx-auto mt-[78px] w-full max-w-[1540px] px-5 md:mt-[108px] md:px-[90px]">
        <h3 className="text-[32px] font-bold leading-[0.95] tracking-[-0.06em] text-[#12362d] md:text-[48px]">
          Key Highlights of The Waterfront
        </h3>

        <p className="mt-[22px] max-w-[1420px] text-[18px] font-bold leading-[1.35] tracking-[-0.035em] text-[#12362d] md:mt-[34px] md:text-[24px]">
        ...
        <h4 className="mt-[30px] text-[32px] font-bold leading-[0.95] tracking-[-0.06em] text-[#12362d] md:mt-[36px] md:text-[48px]">
