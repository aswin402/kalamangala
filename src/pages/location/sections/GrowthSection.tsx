    ...
    <section className="mx-auto mt-[118px] w-full max-w-[1300px] px-5 pb-[82px]">
      ...
      <div className="grid grid-cols-1 gap-[18px] md:grid-cols-3">
        {topCards.map((card) => (
          <article
            key={card.title}
            className="la-card group h-[262px] overflow-hidden rounded-[18px] bg-card-green p-[18px] text-[var(--location-growthsection-text-3)]"
          >
            ...
            <div className="pt-[31px]">
              ...
              <p className="mt-[14px] font-['Inter'] text-[13px] font-black leading-[1.2] tracking-[-0.035em] text-[var(--location-growthsection-text-3)] md:text-[15px]">
                {card.desc}
              </p>
            </div>
          </article>
      ...
      <div className="mt-[26px] grid grid-cols-1 gap-[18px] md:grid-cols-2">
        {bottomCards.map((card) => (
          <article
            key={card.title}
            className="la-card group h-[263px] overflow-hidden rounded-[18px] bg-card-green p-[18px] text-[var(--location-growthsection-text-3)]"
          >
            <div className="h-[128px] overflow-hidden rounded-[7px]">
              <img
                src={card.img}
