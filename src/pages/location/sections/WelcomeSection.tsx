export function WelcomeSection() {
  return (
    <section className="la-reveal mx-auto mt-[34px] flex w-full max-w-[1540px] flex-col items-center px-5 pb-[58px] text-center md:mt-[42px]">
      ...
      <button className="mt-[38px] h-[34px] min-w-[198px] rounded-full bg-card-green px-10 font-['Inter'] text-[14px] font-bold tracking-[-0.04em] text-[var(--location-welcomesection-text-4)] transition duration-300 hover:scale-105 hover:bg-card-green">
        Contact Us
      </button>
    </section>
  );
